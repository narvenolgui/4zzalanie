      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          <div class="w3-display-container">
            <img src="https://cs11.livemaster.ru/storage/topicavatar/600x450/81/e3/b27734f825dc47aeb0dc66ff46ae78c3f38cwg.jpg?h=lUDgpC_QF2-EoxGdowXiiw"
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Круть</h6>
            <p>Все что мне нужно знать</p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>Школа</b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>апрель</h6>
            <p>Мастер</p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>Кодировка</b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>март 2021</h6>
            <p>я крута</p><br>
          </div>
        </div>
        <!-- End Right Column -->
